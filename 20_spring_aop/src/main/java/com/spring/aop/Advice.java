...
public class Advice {
	...
	/*
	//중복되는 타겟팅을 기술
	@Pointcut("execution(public void com.spring.aop.*.work())")
	public void work() {
		// 특정 의미가 없다.
	}
	...
	public void aroundGetWorkingTime(ProceedingJoinPoint pjp) throws Throwable {
		...
		System.out.println("업무소요시간 : " + (endTime - startTime));
		System.out.println("========================\n");
		
	}
	
	// 타겟팅 메서드가 성공적으로 실행된 후
	@AfterReturning("execution(public void com.spring.aop.*.getInfo(String,int))")
